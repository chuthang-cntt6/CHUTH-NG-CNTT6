...
//595 Xu?t ngày theo d?nh d?ng (ng/th/nm)
void XuatNgay(NGAY ng)
{
    printf("%d/%d/%d", ng.Day, ng.Month, ng.Year);
}

//597 Tính s? th? t? ngày trong nam
...
//598 Tính s? th? t? ngày k? t? ngày 1/1/1
...
// 599 Tìm ngày khi bi?t nam và s? th? t? c?a ngày trong nam
...
// 600 Tìm ngày khi bi?t s? th? t? ngày t? nam 1/1/1
...
// Tính th? trong tu?n c?a 1 ngày b?t k?

/*
S? d?ng công th?c Zeller
