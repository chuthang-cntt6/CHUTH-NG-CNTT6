...
{
    DIEM I; // Ði?m có hoành d? l?n nh?t 
...
/*
dùng phuong pháp xét v? trí di?m D so v?i 3 c?nh.
Ði?m D n?u n?m trong tam giác n?u nó thu?c 
1 trong ba c?nh ho?c ? trên(hay bên trái) 2 c?nh và du?i (hay bên ph?i) 1 c?nh ho?c du?i hai c?nh và trên 1 c?nh.
Ð? xét di?m n?m trên hay du?i du?ng th?ng qua hai di?m (x1,y1), (x2,y2) ta dùng công th?c sau:
Vector v1 = {x2-x1, y2-y1}
Vector v2 = {x2-xA, y2-yA}  
Tính xp = v1.x*v2.y - v1.y*v2.x  // Cross product
N?u xp > 0  bên trên
Ngu?c l?i N?u xp < 0 bên du?i
Ngu?c l?i thu?c du?ng th?ng
*/
